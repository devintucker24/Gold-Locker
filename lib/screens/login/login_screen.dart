            ...
            children: [
              Flexible(
                child: Center(
                  child: Text(
                    'Gold Locker',
                    style:  kHeadings.copyWith(fontSize:70, fontWeight: FontWeight.bold ) ,
                  ),
                ),
              ),
              Column(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    suffixIcon: Padding(
                                      ...
                                      child: Icon(FontAwesomeIcons.envelope, size: 30, color: Clay.kClay),
                                      ),
                                      hintText: "Email",
                                      hintStyle: kBodyText),
                          ...
                          child: Padding(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  suffixIcon: Padding(
                                   padding: EdgeInsets.fromLTRB(0, 0, 25, 0),
                                   child: Icon(FontAwesomeIcons.lock, size: 30, color: Clay.kClay),
                                   ),
                                    hintText: 'Password',
                                    hintStyle: kBodyText),
                                 obscureText: true,
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              context.read<AuthenticationService>().signIn(
                                ...
                                child: Text('Log In', style: kBodyText.copyWith(fontSize: 16)),
                              ),
                            ),
                          ),
                      CreateAccountButton(
