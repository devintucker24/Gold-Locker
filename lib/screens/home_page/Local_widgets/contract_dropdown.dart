...
class contract_dropdown extends StatefulWidget {
  const contract_dropdown({Key? key}) : super(key: key);

  @override
  _contract_dropdownState createState() => _contract_dropdownState();
}
...
class _contract_dropdownState extends State<contract_dropdown> {
